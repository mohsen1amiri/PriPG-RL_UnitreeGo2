...
from typing import Dict, TYPE_CHECKING, Any, Callable, NamedTuple, Optional, Protocol, SupportsFloat, Union
...
class CustomDictReplayBufferSamples(NamedTuple):
    observations: TensorDict
    actions: th.Tensor
    next_observations: TensorDict
    dones: th.Tensor
    rewards: th.Tensor
    infos: Dict[str, Any]  # Allows mix of tensors and non-numeric data
...
class CustomRolloutBufferSamples(NamedTuple):
    ...
    advantages: th.Tensor
    returns: th.Tensor
    infos: list[dict[str, Any]]   # or tensor if you pre-processed expert actions
